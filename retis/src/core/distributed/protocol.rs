...
/// Default port for aggregator connections.
pub const DEFAULT_PORT: u16 = 9415;
/// Default listen address for the aggregator.
pub const DEFAULT_LISTEN_ADDR: &str = "0.0.0.0:9415";
pub const MAX_MESSAGE_SIZE: usize = 16 * 1024 * 1024; // 16 MiB
pub const DEFAULT_BATCH_SIZE: usize = 1000;
pub const DEFAULT_FLUSH_INTERVAL_MS: u64 = 100;

// Default local buffer size.
// This number determines max events when paused.
...
/// Backpressure signal.
///
/// When received, collector should buffer locally.
#[derive(Encode, Decode, Debug, Clone)]
pub struct Pause {
...
impl WireDistributedMetadata {
    pub fn from_metadata(meta: &crate::events::DistributedMetadata) -> Self {
        Self {
            ...
            ntp_uncertainty_ns: meta.ntp_uncertainty_ns,

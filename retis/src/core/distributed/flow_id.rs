...
//! raw packet bytes for cross-node flow correlation.
...
///
/// Used for correlating packets belonging to the same network flow across
/// multiple nodes. The flow ID can be canonicalized to match both directions

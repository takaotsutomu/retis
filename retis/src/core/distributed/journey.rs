...
impl Journey {
    ...
    ///
    /// Combined uncertainty uses quadrature (root sum of squares).
...
mod tests {
    ...
    fn make_hop(node_name: &str, epoch_ns: i64, uncertainty_ns: u64, flow_id: &str) -> JourneyHop {
        JourneyHop {
    ...
    #[test]
    fn hop_time_bounds() {
        let hop = make_hop("node1", 1_000_000, 100, "tcp:1.2.3.4:80->5.6.7.8:443");
    ...
    fn journey_cross_node_detection() {
        ...
        single_node
            .hops
            .push(make_hop_with_node_id(node1_id, "node1", 1000, 10, flow));
        single_node
            .hops
            .push(make_hop_with_node_id(node1_id, "node1", 2000, 10, flow));
        ...
        cross_node
            .hops
            .push(make_hop_with_node_id(node2_id, "node2", 2000, 10, flow));
    ...
    fn journey_display_shows_type_and_latency() {
        ...
        journey.hops.push(make_hop_with_node_id(
            node1_id, "node1", 1_000_000, 100, flow,
        ));
        journey.hops.push(make_hop_with_node_id(
            node2_id, "node2", 2_000_000, 100, flow,
        ));
        journey.recompute_timing();

...
mod tests {
    ...
    fn make_hop(node_name: &str, epoch_ns: i64, flow_id: &str) -> JourneyHop {
        JourneyHop {
    ...
    fn journey_cross_node_detection() {
        ...
        single_node
            .hops
            .push(make_hop_with_node_id(node1_id, "node1", 1000, flow));
        single_node
            .hops
            .push(make_hop_with_node_id(node1_id, "node1", 2000, flow));
        ...
        cross_node
            .hops
            .push(make_hop_with_node_id(node2_id, "node2", 2000, flow));
    ...
    fn journey_display_shows_type_and_latency() {
        ...
        journey
            .hops
            .push(make_hop_with_node_id(node1_id, "node1", 1_000_000, flow));
        journey
            .hops
            .push(make_hop_with_node_id(node2_id, "node2", 2_000_000, flow));
        journey.recompute_timing();
